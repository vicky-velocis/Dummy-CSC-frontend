import {
  ...
  import { searchForm } from "./searchMaterilaReceiptResource/searchForm";
  import { searchResults } from "./searchMaterilaReceiptResource/searchResults";
  ...
  const createMaterialMasterHandle = async (state, dispatch) => {
    dispatch(setRoute(`/egov-store-asset/createMaterialReceiptNote`));
  };
  ...
  const getData = async (action, state, dispatch) => {
    ...
    await getSupllierData(action,state, dispatch);
  };
