import {
  ...
  import { searchForm } from "./searchMaterilaReceiptMiscResource/searchForm";
  import { searchResults } from "./searchMaterilaReceiptMiscResource/searchResults";
  ...
  const createMaterialMasterHandle = async (state, dispatch) => {
    dispatch(setRoute(`/egov-store-asset/createMaterialReceiptNoteMisc`));
  };
  ...
  const materialMasterSearchAndResult = {
    ...
    name: "search-material-receipt-misc",
