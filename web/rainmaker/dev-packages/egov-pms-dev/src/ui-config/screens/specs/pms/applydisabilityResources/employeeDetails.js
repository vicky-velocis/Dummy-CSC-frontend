      ...
      employeedetails: getCommonContainer({
        ...
        dateOfRetirement: {
          ...getDateField({
            ...
            pattern: getPattern("Date"),
            jsonPath: "EmployeeTemp[0].dateOfRetirement",
            props: {
              className:"applicant-details-error",
              disabled:true
            }
        ...
        employeeStatus: getTextField({
          ...
          pattern: getPattern("name"),
          jsonPath: "EmployeeTemp[0].employeeStatus"
        }),
        employeeType: getTextField({
            ...
            pattern: getPattern("name"),
            jsonPath: "EmployeeTemp[0].employeeType"
          }),
          ...
          gender: getTextField({
            ...
            pattern: getPattern("name"),
            jsonPath: "EmployeeTemp[0].gender"
          }),
