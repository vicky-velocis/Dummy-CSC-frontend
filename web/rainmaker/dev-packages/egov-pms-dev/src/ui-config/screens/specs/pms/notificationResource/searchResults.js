...
export const searchResults = {
  ...
  props: {
    // data: [],
    columns: [
      getTextToLocalMapping("eventType"),
      getTextToLocalMapping("eventCategory"),
      getTextToLocalMapping("eventname"),
      getTextToLocalMapping("description"),   
     
    ],
    title: getTextToLocalMapping("Search Results for event"),
    options: {
      filter: false,
      download: false,
      responsive: "stacked",
    ...
    ProcessInstances: [
      {
          ...
          previousStatus: null,
          employee: {
            pensionEmployeeId: rowData[7]
          },
          notificationRegister: {
          pensionNotificationRegisterId: rowData[6]
        }
      }       
  ]
  };
