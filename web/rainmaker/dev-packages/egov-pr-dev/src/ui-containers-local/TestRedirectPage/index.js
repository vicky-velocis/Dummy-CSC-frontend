            ...
            <div className="ViewApplicationCard">
              <div class="row no-margin">
                <Formik
                  ...
                  validationSchema={localStorage.getItem('applicationType') == "PRSCP" ? Validation_NOCTPET : localStorage.getItem('applicationType') == "SELLMEATNOC" ? Validation_NOCSELLMEAT : localStorage.getItem('applicationType') == "ADVERTISEMENTNOC" ? Validation_NOCADD : localStorage.getItem('applicationType') == "ROADCUT" ? Validation_NOCROADCUT : ''}
