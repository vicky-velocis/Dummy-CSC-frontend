...
import { billingSearchResults } from "./searchResource/searchResults";
...
import { getGridDataBilling } from "./searchResource/citizenSearchFunctions";
...
const header = getCommonHeader({
  ...
  labelKey: "PR_TENDER_NOTICE_LIST_PUBLISHED"
});
...
const NOCSearchAndResult = {
  ...
  beforeInitScreen: (action, state, dispatch) => {
    getGridDataBilling(action, state, dispatch);
