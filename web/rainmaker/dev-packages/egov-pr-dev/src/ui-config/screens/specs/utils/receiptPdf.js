...
const getApplicationData = async (transformedData, ulbLogo, type) => {
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            {
              text: transformedData.PRStationId,
              border: [false, false, true, true],
              style: "receipt-table-value"
            }
          ]
  ...
  switch (type) {
    ...
    case "certificate":
      ...
      nocSubheadOne = [
        {
          text: [
            ...
            {
              text: transformedData.PublicRelationNumber,
              bold: false
            }
          ],
          alignment: "left"
      ...
      qrText = `Application: ${
        transformedData.applicationNumber
      }, NOC Number: ${transformedData.PublicRelationNumber}, Date of Issue: ${
...
const generatePdf = async (state, dispatch, type) => {
  ...
  switch (type) {
    ...
    case "certificate_download":
      fileName = `noc_certificate_${transformedData.PublicRelationNumber}`;
      application_data = await getApplicationData(
        transformedData,
        ulbLogo,
        "certificate"
