    ...
    PublicRelations: [
      {
        ...
        PublicRelationnumber: "",
        dateofapplied: "1556649000000",
        PublicRelationdetailsid: "201",
        action: "INITIATE",
        applicationnumber: "PB-NOC-201",
        PublicRelationtype: "New",
      ...
      },
      {
        ...
        tenantId: "pb.amritsar",
        PublicRelationnumber: null,
        dateofapplied: null,
        PublicRelationdetailsid: "03d2cae0-b608-4a13-9974-56b7eb73c129",
        action: "INITIATE",
        applicationnumber: "PB-NOC-100",
        PublicRelationtype: "string",
    ...
    PublicRelations: [
      {
        ...
        tenantId: "pb.amritsar",
        PublicRelationNumber: null,
        provisionPublicRelationNumber: null,
        oldPublicRelationNumber: null,
        dateOfApplied: null,
        PublicRelationDetails: {
          id: "951ab026-0c77-4368-a944-10cf07287b86",
          applicationNumber: "PB-FN-2019-06-07-002024",
          status: "INITIATED",
          PublicRelationType: "PROVISIONAL",
...
export const sampleDocUpload = () => {
  return {
    ...
    "12": {
      documentType: "BUILDING",
      documentCode: "BUILDING.PR_FIGHTING_PLAN"
    },
    "13": {
      documentType: "BUILDING",
    ...
    Bill: [
      {
        ...
        taxAndPayments: [
          {
            businessService: "PublicRelation",
            taxAmount: 16500,
            amountPaid: null
          }
        ],
            ...
            billAccountDetails: [
              {
                ...
                isActualDemand: true,
                glcode: null,
                taxHeadCode: "PublicRelation_FEES",
                additionalDetails: null,
                purpose: "CURRENT"
              }
            ],
