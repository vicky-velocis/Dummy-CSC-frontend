...
export const Global_var = {
  ...
  // URL_JSON: 'http://192.168.12.124:8096/egov-opmsService/noc/_getcolumnsmodules?noctype=PRSCP',
  ...
  URL_GETNOC: 'http://192.168.12.116:8010/egov-opmsService/noc/_get',
  URL_ADDNOC: 'http://192.168.12.116:8010/egov-opmsService/noc/_create',
  BASEURL: 'http://192.168.12.116:8096/egov-mdms-service/v1/_get?moduleName=egpm&tenantId=ch&',
  URL_JSON: 'http://192.168.12.116:8009/egov-opmsService/noc/_getcolumnsmodules?noctype=',
  URL_VIEW: '/egov-opmsService/noc/_view',
  URL_UPDATESTATUS: '/egov-opmsService/noc/_updateappstatus',
  URL_POPUPDATA: '/egov-opmsService/noc/_getcolumnsremarks',
  URL_FILEUPLOAD: 'http://192.168.12.124:8083/filestore/v1/files',
  URL_FILEDOWNLOAD: 'http://192.168.12.124:8083/filestore/v1/files/url',
  URL_UPDATE: 'http://192.168.12.116:8009/egov-opmsService/noc/_update',
