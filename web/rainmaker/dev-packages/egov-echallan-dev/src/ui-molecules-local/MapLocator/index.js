...
class MapLocator extends Component {
  ...
  onClickPick = () => {
    ...
    this.props.handleField(
      "apply",
      "components.div.children.formwizardFirstStep.children.violationsDetails.children.cardContent.children.violationsDetailsContainer.children.SILocationDetailsConatiner.children.propertyGisCoordinates.children.gisTextField",
      "props.value",
      `${add.lat}, ${add.lng}`
    );
