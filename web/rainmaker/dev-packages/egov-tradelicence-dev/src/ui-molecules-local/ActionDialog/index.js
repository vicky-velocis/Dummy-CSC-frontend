              ...
              children={
                ...
                >
                  ...
                  <Grid item sm="12">
                    ...
                    /> */}
                    { (buttonLabel == "APPROVE" || buttonLabel == "REJECT" || buttonLabel == "SENDBACK") ? <div style={{height: "10px"}}></div> : <label className="commentsLabel">{fieldConfig.comments.label.labelName}</label>
                    }
