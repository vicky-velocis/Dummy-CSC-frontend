      ...
      applicationSuccessCard: {
        ...
        children: {
          card: acknowledgementCard({
            ...
            body: {
              labelName:
                "A notification regarding ADVERTISEMENT NOC Approval has been sent to the applicant at registered Mobile No.",
              labelKey: "ADV_NOC_APPROVAL_CHECKLIST_MESSAGE_SUB"
            },
            tailText: {
              labelName: "ADVERTISEMENT NOC No.",
              labelKey: "ADV_HOME_SEARCH_RESULTS_NOC_NO_LABEL"
            },
            number: secondNumber
          })
        }
      ...
      applicationSuccessCard: {
        ...
        children: {
          card: acknowledgementCard({
            ...
            body: {
              labelName:
                "A notification regarding ADVERTISEMENT NOC cancellation has been sent to the applicant at registered Mobile No.",
        ...
        children: {
          card: acknowledgementCard({
            ...
            body: {
              ...
              labelKey: "ADV_NOC_PAYMENT_FAILURE_MESSAGE_SUB"
            }
          })
        }
      },
