...
import { footer } from "./petapplyResource/footer";
import { nocDetails , ApplicationDetails } from "./petapplyResource/nocDetails";
import { propertyDetails } from "./petapplyResource/propertyDetails";
import { propertyLocationDetails } from "./petapplyResource/propertyLocationDetails";
import { applicantDetails } from "./petapplyResource/applicantDetails";
import { documentDetails } from "./petapplyResource/documentDetails";
...
export const header = getCommonContainer({
  header: getCommonHeader({
    labelName: `Apply New Permission To Keep Pet Dog`, //later use getFinancialYearDates
    labelKey: "Apply_New_Permission_To_Keep_Pet_Dog"
  }),
...
const screenConfig = {
  ...
  beforeInitScreen: (action, state, dispatch) => {
    ...
    // // Set Property City
    // dispatch(prepareFinalObject("FireNOCs[0].fireNOCDetails.propertyDetails.address.city", getOPMSTenantId()));
